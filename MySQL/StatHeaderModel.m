...
@interface StatHeaderModel ()
{
    NSMutableData *_downloadedData;
}
@end

@implementation StatHeaderModel

- (void)downloadItems
{
    // Download the json file
    
    NSURL *jsonFileUrl = [NSURL URLWithString:@"http://localhost:8888/iosStatisticHeader.php"];
...
- (void)connectionDidFinishLoading:(NSURLConnection *)connection
{
    ...
    if (self.delegate) {
        [self.delegate itemsHeaderDownloaded:_locations];
    }
}
